...
BLOG_AUTHOR = "Ian Henriksen"  # (translatable)
BLOG_TITLE = "Ian's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://insertinterestingnamehere.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "insertinterestingnamehere.github.io"
BLOG_EMAIL = "insertinterestingnamehere@gmail.com"
BLOG_DESCRIPTION = "My comments on math, numerical computing, and the tools used for computational science."  # (translatable)
